...
const Navbar = () => {
    ...
    <>
        ...
        {/* Hero Banner */ }    
        <div className="py-8 xs:py-16 md:py-24 lg:py-40 px-6 sm:px-8 bg-cover text-white text-center flex flex-col justify-center items-center" style={{ backgroundImage: 'url(/img/banner.jpg)', backgroundPosition: '85%' }}>
